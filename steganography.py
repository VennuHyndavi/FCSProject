...
def encode_text(data): 
  ...
  image = cv2.imread("C:\\Users\\Apurva\\OneDrive\\Desktop\\fcsproject\\static\\pikachu.png") # Read the input image using OpenCV-Python.
  #image = Image.open("C:\Users\Apurva\Downloads\majorpro\majorpro\static\pikachu.png")
  print(type(image))
  ...
  cv2.imwrite("C:\\Users\\Apurva\\OneDrive\\Desktop\\fcsproject\\static/"+filename, encoded_image)
...
def decode_text(image_name):
  ...
  image = cv2.imread("static/"+image_name) #read the image using cv2.imread() 
